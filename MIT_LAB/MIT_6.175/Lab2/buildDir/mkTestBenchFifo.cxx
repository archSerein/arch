 ...
 * 
 * On Fri Jun 21 06:48:18 UTC 2024
 * 
 */
...
MOD_mkTestBenchFifo::MOD_mkTestBenchFifo(tSimStateHdl simHdl, char const *name, Module *parent)
  : Module(simHdl, name, parent),
    ...
    INST_referenceFifo_bsfif(simHdl, "referenceFifo_bsfif", this, 32u, 3u, (tUInt8)1u, 0u),
    ...
    DEF_new_value__h718(2863311530u)
{
  symbol_count = 29u;
...
void MOD_mkTestBenchFifo::init_symbols_0()
{
  ...
  init_symbol(&symbols[25u], "x__h2096", SYM_DEF, &DEF_x__h2096, 8u);
  init_symbol(&symbols[26u], "x__h2332", SYM_DEF, &DEF_x__h2332, 8u);
  init_symbol(&symbols[27u], "x__h2489", SYM_DEF, &DEF_x__h2489, 32u);
  init_symbol(&symbols[28u], "x__h2639", SYM_DEF, &DEF_x__h2639, 32u);
}
...
void MOD_mkTestBenchFifo::RL_randomVal1_every()
{
  ...
  {
    rand32();
    DEF_new_value__h718 = rand32();
  }
  INST_randomVal1_zaz.METH_wset(DEF_new_value__h718);
}

void MOD_mkTestBenchFifo::RL_randomVal1_every_1()
{
  DEF_x_wget__h582 = INST_randomVal1_zaz.METH_wget();
  DEF_v__h750 = INST_randomVal1_zaz.METH_whas() ? DEF_x_wget__h582 : 0u;
  INST_randomVal1_ignore.METH_wset(DEF_v__h750);
}
...
void MOD_mkTestBenchFifo::RL_feed()
{
  ...
  DEF_x_wget__h582 = INST_randomVal1_zaz.METH_wget();
  DEF_x__h2332 = INST_feed_count.METH_read();
  DEF_testFifo_d_0_3_BIT_32___d24 = (tUInt8)(DEF_testFifo_d_0___d23 >> 32u);
  DEF_v__h750 = INST_randomVal1_zaz.METH_whas() ? DEF_x_wget__h582 : 0u;
  DEF__1_CONCAT_IF_randomVal1_zaz_whas_THEN_randomVal_ETC___d28 = 8589934591llu & ((((tUInt64)((tUInt8)1u)) << 32u) | (tUInt64)(DEF_v__h750));
  ...
  DEF_x__h2313 = (tUInt8)255u & (DEF_x__h2332 + (tUInt8)1u);
  DEF_NOT_testFifo_d_0_3_BIT_32_4___d31 = !DEF_testFifo_d_0_3_BIT_32___d24;
  INST_referenceFifo_bsfif.METH_enq(DEF_v__h750);
  INST_feed_count.METH_write(DEF_x__h2313);
  ...
  if (!(PORT_RST_N == (tUInt8)0u))
    dollar_display(sim_hdl, this, "s,32", &__str_literal_1, DEF_v__h750);
}

void MOD_mkTestBenchFifo::RL_stream()
{
  tUInt8 DEF_NOT_IF_testFifo_d_0_3_BIT_32_4_THEN_testFifo_d_ETC___d44;
  tUInt32 DEF_t__h1912;
  tUInt64 DEF__0_CONCAT_DONTCARE___d36;
  tUInt64 DEF_IF_testFifo_d_1_5_BIT_32_6_THEN_testFifo_d_1_5_ETC___d37;
  tUInt32 DEF_x__h1951;
  tUInt32 DEF_r__h1911;
  DEF_testFifo_d_2___d9 = INST_testFifo_d_2.METH_read();
  DEF_testFifo_d_1___d25 = INST_testFifo_d_1.METH_read();
  DEF_testFifo_d_1_5_BIT_32___d26 = (tUInt8)(DEF_testFifo_d_1___d25 >> 32u);
  DEF_testFifo_d_0___d23 = INST_testFifo_d_0.METH_read();
  DEF_x__h2096 = INST_stream_count.METH_read();
  DEF_r__h1911 = INST_referenceFifo_bsfif.METH_first();
  DEF_x__h1951 = (tUInt32)(DEF_testFifo_d_0___d23);
  DEF__0_CONCAT_DONTCARE___d36 = 2863311530llu;
  DEF_IF_testFifo_d_1_5_BIT_32_6_THEN_testFifo_d_1_5_ETC___d37 = DEF_testFifo_d_1_5_BIT_32___d26 ? DEF_testFifo_d_1___d25 : DEF__0_CONCAT_DONTCARE___d36;
  DEF_t__h1912 = DEF_x__h1951;
  DEF_NOT_IF_testFifo_d_0_3_BIT_32_4_THEN_testFifo_d_ETC___d44 = !(DEF_t__h1912 == DEF_r__h1911);
  DEF_x__h2084 = (tUInt8)255u & (DEF_x__h2096 + (tUInt8)1u);
  INST_testFifo_d_0.METH_write(DEF_IF_testFifo_d_1_5_BIT_32_6_THEN_testFifo_d_1_5_ETC___d37);
  INST_delay.METH_write(0u);
  if (DEF_testFifo_d_1_5_BIT_32___d26)
    INST_testFifo_d_1.METH_write(DEF_testFifo_d_2___d9);
  if (DEF_testFifo_d_1_5_BIT_32___d26)
    INST_testFifo_d_2.METH_write(DEF__0_CONCAT_DONTCARE___d36);
  if (!(PORT_RST_N == (tUInt8)0u))
    dollar_display(sim_hdl, this, "s", &__str_literal_2);
  INST_stream_count.METH_write(DEF_x__h2084);
  INST_referenceFifo_bsfif.METH_deq();
  if (!(PORT_RST_N == (tUInt8)0u))
  {
    if (DEF_NOT_IF_testFifo_d_0_3_BIT_32_4_THEN_testFifo_d_ETC___d44)
      dollar_display(sim_hdl, this, "s,32,32", &__str_literal_3, DEF_r__h1911, DEF_t__h1912);
    if (DEF_NOT_IF_testFifo_d_0_3_BIT_32_4_THEN_testFifo_d_ETC___d44)
...
void MOD_mkTestBenchFifo::RL_enqueueThree()
{
  ...
  DEF_x_wget__h582 = INST_randomVal1_zaz.METH_wget();
  DEF_x__h2332 = INST_feed_count.METH_read();
  DEF_x__h2489 = INST_enqueue3.METH_read();
  DEF_testFifo_d_0_3_BIT_32___d24 = (tUInt8)(DEF_testFifo_d_0___d23 >> 32u);
  DEF_v__h750 = INST_randomVal1_zaz.METH_whas() ? DEF_x_wget__h582 : 0u;
  DEF__1_CONCAT_IF_randomVal1_zaz_whas_THEN_randomVal_ETC___d28 = 8589934591llu & ((((tUInt64)((tUInt8)1u)) << 32u) | (tUInt64)(DEF_v__h750));
  DEF_testFifo_d_0_3_BIT_32_4_AND_NOT_testFifo_d_1_5_ETC___d30 = DEF_testFifo_d_0_3_BIT_32___d24 && !DEF_testFifo_d_1_5_BIT_32___d26;
  ...
  DEF_NOT_testFifo_d_0_3_BIT_32_4___d31 = !DEF_testFifo_d_0_3_BIT_32___d24;
  DEF_x__h2313 = (tUInt8)255u & (DEF_x__h2332 + (tUInt8)1u);
  DEF_x__h2201 = DEF_x__h2489 + 1u;
  INST_delay.METH_write(0u);
  INST_enqueue3.METH_write(DEF_x__h2201);
  INST_referenceFifo_bsfif.METH_enq(DEF_v__h750);
  INST_feed_count.METH_write(DEF_x__h2313);
  if (DEF_testFifo_d_0_3_BIT_32_4_AND_testFifo_d_1_5_BIT_ETC___d27)
    INST_testFifo_d_2.METH_write(DEF__1_CONCAT_IF_randomVal1_zaz_whas_THEN_randomVal_ETC___d28);
  ...
  if (DEF_NOT_testFifo_d_0_3_BIT_32_4___d31)
    INST_testFifo_d_0.METH_write(DEF__1_CONCAT_IF_randomVal1_zaz_whas_THEN_randomVal_ETC___d28);
  if (!(PORT_RST_N == (tUInt8)0u))
    dollar_display(sim_hdl, this, "s,32", &__str_literal_6, DEF_v__h750);
}
...
{
  tUInt32 DEF_x__h2620;
  tUInt32 DEF_x__h2643;
  tUInt32 DEF_x__h2647;
  DEF_x__h2639 = INST_delay.METH_read();
  DEF_x__h2647 = INST_cycle_count.METH_read();
  DEF_x__h2643 = DEF_x__h2647 + 1u;
  DEF_x__h2620 = DEF_x__h2639 + 1u;
  INST_delay.METH_write(DEF_x__h2620);
  INST_cycle_count.METH_write(DEF_x__h2643);
}
...
unsigned int MOD_mkTestBenchFifo::dump_VCD_defs(unsigned int levels)
{
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "new_value__h718", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  ...
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "v__h750", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h2084", 8u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h2096", 8u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h2313", 8u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h2332", 8u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h2489", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x__h2639", 32u);
  vcd_set_clock(sim_hdl, num, __clk_handle_0);
  vcd_write_def(sim_hdl, num++, "x_wget__h582", 32u);
...
void MOD_mkTestBenchFifo::vcd_defs(tVCDDumpType dt, MOD_mkTestBenchFifo &backing)
{
  ...
  if (dt == VCD_DUMP_XS)
  {
	...
	backing.DEF__1_CONCAT_IF_randomVal1_zaz_whas_THEN_randomVal_ETC___d28 = DEF__1_CONCAT_IF_randomVal1_zaz_whas_THEN_randomVal_ETC___d28;
      ...
      ++num;
      if ((backing.DEF_new_value__h718) != DEF_new_value__h718)
      {
	vcd_write_val(sim_hdl, num, DEF_new_value__h718, 32u);
	backing.DEF_new_value__h718 = DEF_new_value__h718;
      }
      ++num;
	...
	backing.DEF_testFifo_d_2___d9 = DEF_testFifo_d_2___d9;
      ...
      ++num;
      if ((backing.DEF_v__h750) != DEF_v__h750)
      {
	vcd_write_val(sim_hdl, num, DEF_v__h750, 32u);
	backing.DEF_v__h750 = DEF_v__h750;
      }
      ++num;
      if ((backing.DEF_x__h2084) != DEF_x__h2084)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h2084, 8u);
	backing.DEF_x__h2084 = DEF_x__h2084;
      }
      ++num;
      if ((backing.DEF_x__h2096) != DEF_x__h2096)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h2096, 8u);
	backing.DEF_x__h2096 = DEF_x__h2096;
      }
      ++num;
      if ((backing.DEF_x__h2313) != DEF_x__h2313)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h2313, 8u);
	backing.DEF_x__h2313 = DEF_x__h2313;
      }
      ++num;
      if ((backing.DEF_x__h2332) != DEF_x__h2332)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h2332, 8u);
	backing.DEF_x__h2332 = DEF_x__h2332;
      }
      ++num;
      if ((backing.DEF_x__h2489) != DEF_x__h2489)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h2489, 32u);
	backing.DEF_x__h2489 = DEF_x__h2489;
      }
      ++num;
      if ((backing.DEF_x__h2639) != DEF_x__h2639)
      {
	vcd_write_val(sim_hdl, num, DEF_x__h2639, 32u);
	backing.DEF_x__h2639 = DEF_x__h2639;
      }
      ++num;
      if ((backing.DEF_x_wget__h582) != DEF_x_wget__h582)
      {
	vcd_write_val(sim_hdl, num, DEF_x_wget__h582, 32u);
	backing.DEF_x_wget__h582 = DEF_x_wget__h582;
      }
      ++num;
    }
    else
