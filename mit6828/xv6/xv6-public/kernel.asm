...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 4f 59 10 80 	movl   $0x8010594f,0x14(%eax)
  p->context = (struct context*)sp;
...
801039d1:	e8 1a 32 00 00       	call   80106bf0 <inituvm>
...
80103abb:	e8 20 30 00 00       	call   80106ae0 <switchuvm>
  return 0;
...
80103b48:	e8 e3 34 00 00       	call   80107030 <copyuvm>
...
80103c92:	e8 e4 0b 00 00       	call   8010487b <swtch>
      switchkvm();
80103c97:	e8 34 2e 00 00       	call   80106ad0 <switchkvm>
      c->proc = 0;
...
80103f89:	e8 32 2f 00 00       	call   80106ec0 <freevm>
        p->pid = 0;
...
801041fb:	68 ff 7b 10 80       	push   $0x80107bff
...
80104c04:	68 dc 79 10 80       	push   $0x801079dc
...
80104c1c:	68 db 79 10 80       	push   $0x801079db
...
80104c31:	68 cf 79 10 80       	push   $0x801079cf
...
80104c4f:	68 de 79 10 80       	push   $0x801079de
80104c54:	e8 27 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c59:	83 ec 0c             	sub    $0xc,%esp
80104c5c:	68 c0 79 10 80       	push   $0x801079c0
...
80104cf4:	56                   	push   %esi
  if(argint(n, &fd) < 0)
80104cf5:	8d 75 e4             	lea    -0x1c(%ebp),%esi
{
80104cf8:	53                   	push   %ebx
80104cf9:	83 ec 24             	sub    $0x24,%esp
  if(argint(n, &fd) < 0)
80104cfc:	56                   	push   %esi
80104cfd:	6a 00                	push   $0x0
80104cff:	e8 1c fc ff ff       	call   80104920 <argint>
80104d04:	83 c4 10             	add    $0x10,%esp
80104d07:	85 c0                	test   %eax,%eax
80104d09:	0f 88 91 00 00 00    	js     80104da0 <sys_dup2+0xb0>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104d0f:	83 7d e4 0f          	cmpl   $0xf,-0x1c(%ebp)
80104d13:	0f 87 87 00 00 00    	ja     80104da0 <sys_dup2+0xb0>
80104d19:	e8 52 ec ff ff       	call   80103970 <myproc>
80104d1e:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80104d21:	8b 7c 98 28          	mov    0x28(%eax,%ebx,4),%edi
80104d25:	85 ff                	test   %edi,%edi
80104d27:	74 77                	je     80104da0 <sys_dup2+0xb0>
  if(argfd(0,&old_fd,&f1) < 0 || argint(1,&new_fd) < 0)
80104d29:	83 ec 08             	sub    $0x8,%esp
80104d2c:	56                   	push   %esi
80104d2d:	6a 01                	push   $0x1
80104d2f:	e8 ec fb ff ff       	call   80104920 <argint>
80104d34:	83 c4 10             	add    $0x10,%esp
80104d37:	85 c0                	test   %eax,%eax
80104d39:	78 65                	js     80104da0 <sys_dup2+0xb0>
  if(new_fd < 0 || new_fd > NOFILE)
80104d3b:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80104d3e:	83 f8 10             	cmp    $0x10,%eax
80104d41:	77 5d                	ja     80104da0 <sys_dup2+0xb0>
  if(new_fd != old_fd)
80104d43:	39 d8                	cmp    %ebx,%eax
80104d45:	75 11                	jne    80104d58 <sys_dup2+0x68>
}
80104d47:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
80104d58:	e8 13 ec ff ff       	call   80103970 <myproc>
80104d5d:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80104d60:	8b 44 90 28          	mov    0x28(%eax,%edx,4),%eax
    if(f2)
80104d64:	85 c0                	test   %eax,%eax
80104d66:	74 0c                	je     80104d74 <sys_dup2+0x84>
      fileclose(f2);
80104d68:	83 ec 0c             	sub    $0xc,%esp
80104d6b:	50                   	push   %eax
80104d6c:	e8 7f c1 ff ff       	call   80100ef0 <fileclose>
80104d71:	83 c4 10             	add    $0x10,%esp
    myproc()->ofile[new_fd] = f1;
80104d74:	e8 f7 eb ff ff       	call   80103970 <myproc>
80104d79:	8b 55 e4             	mov    -0x1c(%ebp),%edx
    filedup(f1);
80104d7c:	83 ec 0c             	sub    $0xc,%esp
    myproc()->ofile[new_fd] = f1;
80104d7f:	89 7c 90 28          	mov    %edi,0x28(%eax,%edx,4)
    filedup(f1);
80104d83:	57                   	push   %edi
80104d84:	e8 17 c1 ff ff       	call   80100ea0 <filedup>
  return new_fd;
80104d89:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80104d8c:	83 c4 10             	add    $0x10,%esp
}
80104d8f:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
80104da5:	eb a0                	jmp    80104d47 <sys_dup2+0x57>
...
80104e14:	e8 07 c2 ff ff       	call   80101020 <fileread>
...
80104e69:	e8 b2 fa ff ff       	call   80104920 <argint>
...
80104e7e:	e8 ed fa ff ff       	call   80104970 <argptr>
...
80104e94:	e8 17 c2 ff ff       	call   801010b0 <filewrite>
...
80104ee1:	74 25                	je     80104f08 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104ee3:	e8 88 ea ff ff       	call   80103970 <myproc>
  fileclose(f);
...
80104ef4:	e8 f7 bf ff ff       	call   80100ef0 <fileclose>
  return 0;
...
80104f48:	e8 23 fa ff ff       	call   80104970 <argptr>
...
80104f5b:	e8 70 c0 ff ff       	call   80100fd0 <filestat>
...
80104f8f:	e8 4c fa ff ff       	call   801049e0 <argstr>
...
80104fd9:	e8 a2 c7 ff ff       	call   80101780 <ilock>
  if(ip->type == T_DIR){
...
80104ff8:	e8 d3 c6 ff ff       	call   801016d0 <iupdate>
  iunlock(ip);
80104ffd:	89 1c 24             	mov    %ebx,(%esp)
80105000:	e8 5b c8 ff ff       	call   80101860 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80105005:	58                   	pop    %eax
80105006:	5a                   	pop    %edx
80105007:	57                   	push   %edi
80105008:	ff 75 d0             	push   -0x30(%ebp)
8010500b:	e8 b0 d0 ff ff       	call   801020c0 <nameiparent>
...
8010501d:	e8 5e c7 ff ff       	call   80101780 <ilock>
...
80105033:	e8 a8 cf ff ff       	call   80101fe0 <dirlink>
...
80105043:	e8 c8 c9 ff ff       	call   80101a10 <iunlockput>
  iput(ip);
80105048:	89 1c 24             	mov    %ebx,(%esp)
8010504b:	e8 60 c8 ff ff       	call   801018b0 <iput>
  end_op();
80105050:	e8 7b dd ff ff       	call   80102dd0 <end_op>
  return 0;
...
8010506c:	e8 9f c9 ff ff       	call   80101a10 <iunlockput>
    goto bad;
...
80105085:	e8 46 c6 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
8010508a:	89 1c 24             	mov    %ebx,(%esp)
8010508d:	e8 7e c9 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105092:	e8 39 dd ff ff       	call   80102dd0 <end_op>
  return -1;
...
801050a5:	e8 66 c9 ff ff       	call   80101a10 <iunlockput>
    end_op();
801050aa:	e8 21 dd ff ff       	call   80102dd0 <end_op>
    return -1;
801050af:	83 c4 10             	add    $0x10,%esp
801050b2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801050b7:	eb a1                	jmp    8010505a <sys_link+0xda>
    end_op();
801050b9:	e8 12 dd ff ff       	call   80102dd0 <end_op>
    return -1;
...
8010511d:	58                   	pop    %eax
8010511e:	5a                   	pop    %edx
8010511f:	68 dc 79 10 80       	push   $0x801079dc
80105124:	53                   	push   %ebx
80105125:	e8 96 cb ff ff       	call   80101cc0 <namecmp>
...
80105138:	68 db 79 10 80       	push   $0x801079db
8010513d:	53                   	push   %ebx
8010513e:	e8 7d cb ff ff       	call   80101cc0 <namecmp>
...
80105157:	e8 84 cb ff ff       	call   80101ce0 <dirlookup>
...
801051c2:	e8 49 c8 ff ff       	call   80101a10 <iunlockput>
  ip->nlink--;
801051c7:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
801051cc:	89 1c 24             	mov    %ebx,(%esp)
801051cf:	e8 fc c4 ff ff       	call   801016d0 <iupdate>
  iunlockput(ip);
801051d4:	89 1c 24             	mov    %ebx,(%esp)
801051d7:	e8 34 c8 ff ff       	call   80101a10 <iunlockput>
  end_op();
801051dc:	e8 ef db ff ff       	call   80102dd0 <end_op>
  return 0;
...
8010520d:	e8 7e c8 ff ff       	call   80101a90 <readi>
...
80105236:	e8 d5 c7 ff ff       	call   80101a10 <iunlockput>
  end_op();
8010523b:	e8 90 db ff ff       	call   80102dd0 <end_op>
  return -1;
...
8010525c:	e8 6f c4 ff ff       	call   801016d0 <iupdate>
...
8010526e:	e9 73 ff ff ff       	jmp    801051e6 <sys_unlink+0x116>
    end_op();
80105273:	e8 58 db ff ff       	call   80102dd0 <end_op>
    return -1;
...
801052bf:	e8 1c f7 ff ff       	call   801049e0 <argstr>
...
801052d8:	e8 43 f6 ff ff       	call   80104920 <argint>
...
801052e2:	78 79                	js     8010535d <sys_open+0xad>
  ...
  begin_op();
801052e4:	e8 77 da ff ff       	call   80102d60 <begin_op>
...
801052f5:	e8 a6 cd ff ff       	call   801020a0 <namei>
...
8010530b:	e8 70 c4 ff ff       	call   80101780 <ilock>
...
80105327:	74 23                	je     8010534c <sys_open+0x9c>
  struct proc *curproc = myproc();
80105329:	e8 42 e6 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105344:	e8 a7 bb ff ff       	call   80100ef0 <fileclose>
80105349:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
8010534c:	83 ec 0c             	sub    $0xc,%esp
8010534f:	56                   	push   %esi
80105350:	e8 bb c6 ff ff       	call   80101a10 <iunlockput>
    end_op();
...
80105377:	e8 54 f7 ff ff       	call   80104ad0 <create>
    if(ip == 0){
...
801053a0:	e8 bb c4 ff ff       	call   80101860 <iunlock>
  end_op();
...
80105404:	e8 d7 f5 ff ff       	call   801049e0 <argstr>
...
8010541f:	e8 ac f6 ff ff       	call   80104ad0 <create>
...
8010542f:	e8 dc c5 ff ff       	call   80101a10 <iunlockput>
  end_op();
80105434:	e8 97 d9 ff ff       	call   80102dd0 <end_op>
  return 0;
...
80105479:	e8 a2 f4 ff ff       	call   80104920 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010548e:	e8 8d f4 ff ff       	call   80104920 <argint>
     argint(1, &major) < 0 ||
...
801054ae:	e8 1d f6 ff ff       	call   80104ad0 <create>
     argint(2, &minor) < 0 ||
...
801054be:	e8 4d c5 ff ff       	call   80101a10 <iunlockput>
  end_op();
...
8010550f:	e8 8c cb ff ff       	call   801020a0 <namei>
...
80105521:	e8 5a c2 ff ff       	call   80101780 <ilock>
  if(ip->type != T_DIR){
...
80105534:	e8 27 c3 ff ff       	call   80101860 <iunlock>
  iput(curproc->cwd);
80105539:	58                   	pop    %eax
8010553a:	ff 76 68             	push   0x68(%esi)
8010553d:	e8 6e c3 ff ff       	call   801018b0 <iput>
  end_op();
80105542:	e8 89 d8 ff ff       	call   80102dd0 <end_op>
  curproc->cwd = ip;
...
80105564:	e8 a7 c4 ff ff       	call   80101a10 <iunlockput>
    end_op();
80105569:	e8 62 d8 ff ff       	call   80102dd0 <end_op>
    return -1;
...
801055a5:	e8 36 f4 ff ff       	call   801049e0 <argstr>
...
801055c1:	e8 5a f3 ff ff       	call   80104920 <argint>
...
801055e0:	e8 7b f0 ff ff       	call   80104660 <memset>
...
8010560a:	e8 81 f2 ff ff       	call   80104890 <fetchint>
...
80105628:	e8 a3 f2 ff ff       	call   801048d0 <fetchstr>
...
80105691:	e8 da f2 ff ff       	call   80104970 <argptr>
...
801056a8:	e8 83 dd ff ff       	call   80103430 <pipealloc>
...
801056b7:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801056b9:	e8 b2 e2 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801056d6:	e8 15 b8 ff ff       	call   80100ef0 <fileclose>
    fileclose(wf);
801056db:	58                   	pop    %eax
801056dc:	ff 75 e4             	push   -0x1c(%ebp)
801056df:	e8 0c b8 ff ff       	call   80100ef0 <fileclose>
    return -1;
...
{
  return fork();
80105750:	e9 bb e3 ff ff       	jmp    80103b10 <fork>
...
80105763:	83 ec 08             	sub    $0x8,%esp
  exit();
80105766:	e8 25 e6 ff ff       	call   80103d90 <exit>
...
{
  return wait();
80105770:	e9 4b e7 ff ff       	jmp    80103ec0 <wait>
...
8010578c:	e8 8f f1 ff ff       	call   80104920 <argint>
...
8010579e:	e8 bd e9 ff ff       	call   80104160 <kill>
...
801057c3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801057c6:	e8 a5 e1 ff ff       	call   80103970 <myproc>
...
8010590e:	e8 5d f0 ff ff       	call   80104970 <argptr>
...
8010591d:	ff 75 f4             	push   -0xc(%ebp)
80105920:	e8 ab d0 ff ff       	call   801029d0 <cmostime>
  return 0;
...
801059ae:	00 00 ef 
  initlock(&tickslock, "time");
801059b1:	68 21 7a 10 80       	push   $0x80107a21
801059b6:	68 80 3c 11 80       	push   $0x80113c80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801059bb:	66 a3 c0 3e 11 80    	mov    %ax,0x80113ec0
801059c1:	c1 e8 10             	shr    $0x10,%eax
801059c4:	66 a3 c6 3e 11 80    	mov    %ax,0x80113ec6
  initlock(&tickslock, "time");
801059ca:	e8 01 ea ff ff       	call   801043d0 <initlock>
}
...
80105a34:	ff 24 85 c8 7a 10 80 	jmp    *-0x7fef8538(,%eax,4)
...
80105ae0:	e8 6b de ff ff       	call   80103950 <cpuid>
...
80105af1:	e8 7a de ff ff       	call   80103970 <myproc>
...
80105b15:	68 84 7a 10 80       	push   $0x80107a84
80105b1a:	e8 81 ab ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105b1f:	83 c4 20             	add    $0x20,%esp
80105b22:	e8 49 de ff ff       	call   80103970 <myproc>
80105b27:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b2e:	e8 3d de ff ff       	call   80103970 <myproc>
...
80105b44:	0f 85 3e ff ff ff    	jne    80105a88 <trap+0x78>
    yield();
80105b4a:	e8 a1 e4 ff ff       	call   80103ff0 <yield>
...
80105b5f:	e8 ec dd ff ff       	call   80103950 <cpuid>
80105b64:	57                   	push   %edi
80105b65:	56                   	push   %esi
80105b66:	50                   	push   %eax
80105b67:	68 2c 7a 10 80       	push   $0x80107a2c
...
80105ba5:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105ba8:	e8 b3 ee ff ff       	call   80104a60 <syscall>
    if(myproc()->killed)
...
80105bc3:	5d                   	pop    %ebp
      exit();
80105bc4:	e9 c7 e1 ff ff       	jmp    80103d90 <exit>
...
80105c0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105c10:	e8 3b dd ff ff       	call   80103950 <cpuid>
...
80105c25:	e8 76 e9 ff ff       	call   801045a0 <acquire>
      wakeup(&ticks);
80105c2a:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
      ticks++;
80105c31:	83 05 60 3c 11 80 01 	addl   $0x1,0x80113c60
      wakeup(&ticks);
80105c38:	e8 c3 e4 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105c3d:	c7 04 24 80 3c 11 80 	movl   $0x80113c80,(%esp)
80105c44:	e8 f7 e8 ff ff       	call   80104540 <release>
...
80105c51:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80105c58:	e8 33 e1 ff ff       	call   80103d90 <exit>
...
80105d27:	74 78                	je     80105da1 <uartinit+0xd1>
  uart = 1;
80105d29:	c7 05 c0 44 11 80 01 	movl   $0x1,0x801144c0
80105d30:	00 00 00 
...
80105d3c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105d3f:	bf 48 7b 10 80       	mov    $0x80107b48,%edi
...
80105e27:	6a 00                	push   $0x0
  jmp alltraps
80105e29:	e9 09 fb ff ff       	jmp    80105937 <alltraps>
...
80105e30:	6a 01                	push   $0x1
  jmp alltraps
80105e32:	e9 00 fb ff ff       	jmp    80105937 <alltraps>
...
80105e54:	6a 05                	push   $0x5
  jmp alltraps
80105e56:	e9 dc fa ff ff       	jmp    80105937 <alltraps>
...
80105e5d:	6a 06                	push   $0x6
  jmp alltraps
80105e5f:	e9 d3 fa ff ff       	jmp    80105937 <alltraps>
...
80105e66:	6a 07                	push   $0x7
  jmp alltraps
80105e68:	e9 ca fa ff ff       	jmp    80105937 <alltraps>
...
80105e7d:	6a 0a                	push   $0xa
  jmp alltraps
80105e7f:	e9 b3 fa ff ff       	jmp    80105937 <alltraps>
...
80105e8b:	6a 0c                	push   $0xc
  jmp alltraps
80105e8d:	e9 a5 fa ff ff       	jmp    80105937 <alltraps>
...
80105e92:	6a 0d                	push   $0xd
  jmp alltraps
80105e94:	e9 9e fa ff ff       	jmp    80105937 <alltraps>
...
80105e99:	6a 0e                	push   $0xe
  jmp alltraps
80105e9b:	e9 97 fa ff ff       	jmp    80105937 <alltraps>
...
80105ea2:	6a 0f                	push   $0xf
  jmp alltraps
80105ea4:	e9 8e fa ff ff       	jmp    80105937 <alltraps>
...
80105eab:	6a 10                	push   $0x10
  jmp alltraps
80105ead:	e9 85 fa ff ff       	jmp    80105937 <alltraps>
...
80105eb2:	6a 11                	push   $0x11
  jmp alltraps
80105eb4:	e9 7e fa ff ff       	jmp    80105937 <alltraps>
...
80105ebb:	6a 12                	push   $0x12
  jmp alltraps
80105ebd:	e9 75 fa ff ff       	jmp    80105937 <alltraps>
...
80105ec4:	6a 13                	push   $0x13
  jmp alltraps
80105ec6:	e9 6c fa ff ff       	jmp    80105937 <alltraps>
...
80105ecd:	6a 14                	push   $0x14
  jmp alltraps
80105ecf:	e9 63 fa ff ff       	jmp    80105937 <alltraps>
...
80105ed6:	6a 15                	push   $0x15
  jmp alltraps
80105ed8:	e9 5a fa ff ff       	jmp    80105937 <alltraps>
...
80105edf:	6a 16                	push   $0x16
  jmp alltraps
80105ee1:	e9 51 fa ff ff       	jmp    80105937 <alltraps>
...
80105ee8:	6a 17                	push   $0x17
  jmp alltraps
80105eea:	e9 48 fa ff ff       	jmp    80105937 <alltraps>
...
80105ef1:	6a 18                	push   $0x18
  jmp alltraps
80105ef3:	e9 3f fa ff ff       	jmp    80105937 <alltraps>
...
80105efa:	6a 19                	push   $0x19
  jmp alltraps
80105efc:	e9 36 fa ff ff       	jmp    80105937 <alltraps>
...
80105f03:	6a 1a                	push   $0x1a
  jmp alltraps
80105f05:	e9 2d fa ff ff       	jmp    80105937 <alltraps>
...
80105f0c:	6a 1b                	push   $0x1b
  jmp alltraps
80105f0e:	e9 24 fa ff ff       	jmp    80105937 <alltraps>
...
80105f15:	6a 1c                	push   $0x1c
  jmp alltraps
80105f17:	e9 1b fa ff ff       	jmp    80105937 <alltraps>
...
80105f1e:	6a 1d                	push   $0x1d
  jmp alltraps
80105f20:	e9 12 fa ff ff       	jmp    80105937 <alltraps>
...
80105f27:	6a 1e                	push   $0x1e
  jmp alltraps
80105f29:	e9 09 fa ff ff       	jmp    80105937 <alltraps>
...
80105f30:	6a 1f                	push   $0x1f
  jmp alltraps
80105f32:	e9 00 fa ff ff       	jmp    80105937 <alltraps>
...
80105f39:	6a 20                	push   $0x20
  jmp alltraps
80105f3b:	e9 f7 f9 ff ff       	jmp    80105937 <alltraps>
...
80105f42:	6a 21                	push   $0x21
  jmp alltraps
80105f44:	e9 ee f9 ff ff       	jmp    80105937 <alltraps>
...
80105f4b:	6a 22                	push   $0x22
  jmp alltraps
80105f4d:	e9 e5 f9 ff ff       	jmp    80105937 <alltraps>
...
80105f54:	6a 23                	push   $0x23
  jmp alltraps
80105f56:	e9 dc f9 ff ff       	jmp    80105937 <alltraps>
...
80105f5d:	6a 24                	push   $0x24
  jmp alltraps
80105f5f:	e9 d3 f9 ff ff       	jmp    80105937 <alltraps>
...
80105f66:	6a 25                	push   $0x25
  jmp alltraps
80105f68:	e9 ca f9 ff ff       	jmp    80105937 <alltraps>
...
80105f6f:	6a 26                	push   $0x26
  jmp alltraps
80105f71:	e9 c1 f9 ff ff       	jmp    80105937 <alltraps>
...
80105f78:	6a 27                	push   $0x27
  jmp alltraps
80105f7a:	e9 b8 f9 ff ff       	jmp    80105937 <alltraps>
...
80105f81:	6a 28                	push   $0x28
  jmp alltraps
80105f83:	e9 af f9 ff ff       	jmp    80105937 <alltraps>
...
80105f8a:	6a 29                	push   $0x29
  jmp alltraps
80105f8c:	e9 a6 f9 ff ff       	jmp    80105937 <alltraps>
...
80105f93:	6a 2a                	push   $0x2a
  jmp alltraps
80105f95:	e9 9d f9 ff ff       	jmp    80105937 <alltraps>
...
80105f9c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f9e:	e9 94 f9 ff ff       	jmp    80105937 <alltraps>
...
80105fa5:	6a 2c                	push   $0x2c
  jmp alltraps
80105fa7:	e9 8b f9 ff ff       	jmp    80105937 <alltraps>
...
80105fae:	6a 2d                	push   $0x2d
  jmp alltraps
80105fb0:	e9 82 f9 ff ff       	jmp    80105937 <alltraps>
...
80105fb7:	6a 2e                	push   $0x2e
  jmp alltraps
80105fb9:	e9 79 f9 ff ff       	jmp    80105937 <alltraps>
...
80105fc0:	6a 2f                	push   $0x2f
  jmp alltraps
80105fc2:	e9 70 f9 ff ff       	jmp    80105937 <alltraps>
...
80105fc9:	6a 30                	push   $0x30
  jmp alltraps
80105fcb:	e9 67 f9 ff ff       	jmp    80105937 <alltraps>
...
80105fd2:	6a 31                	push   $0x31
  jmp alltraps
80105fd4:	e9 5e f9 ff ff       	jmp    80105937 <alltraps>
...
80105fdb:	6a 32                	push   $0x32
  jmp alltraps
80105fdd:	e9 55 f9 ff ff       	jmp    80105937 <alltraps>
...
80105fe4:	6a 33                	push   $0x33
  jmp alltraps
80105fe6:	e9 4c f9 ff ff       	jmp    80105937 <alltraps>
...
80105fed:	6a 34                	push   $0x34
  jmp alltraps
80105fef:	e9 43 f9 ff ff       	jmp    80105937 <alltraps>
...
80105ff6:	6a 35                	push   $0x35
  jmp alltraps
80105ff8:	e9 3a f9 ff ff       	jmp    80105937 <alltraps>
...
80105fff:	6a 36                	push   $0x36
  jmp alltraps
80106001:	e9 31 f9 ff ff       	jmp    80105937 <alltraps>
...
80106008:	6a 37                	push   $0x37
  jmp alltraps
8010600a:	e9 28 f9 ff ff       	jmp    80105937 <alltraps>
...
80106011:	6a 38                	push   $0x38
  jmp alltraps
80106013:	e9 1f f9 ff ff       	jmp    80105937 <alltraps>
...
8010601a:	6a 39                	push   $0x39
  jmp alltraps
8010601c:	e9 16 f9 ff ff       	jmp    80105937 <alltraps>
...
80106023:	6a 3a                	push   $0x3a
  jmp alltraps
80106025:	e9 0d f9 ff ff       	jmp    80105937 <alltraps>
...
8010602c:	6a 3b                	push   $0x3b
  jmp alltraps
8010602e:	e9 04 f9 ff ff       	jmp    80105937 <alltraps>
...
80106035:	6a 3c                	push   $0x3c
  jmp alltraps
80106037:	e9 fb f8 ff ff       	jmp    80105937 <alltraps>
...
8010603e:	6a 3d                	push   $0x3d
  jmp alltraps
80106040:	e9 f2 f8 ff ff       	jmp    80105937 <alltraps>
...
80106047:	6a 3e                	push   $0x3e
  jmp alltraps
80106049:	e9 e9 f8 ff ff       	jmp    80105937 <alltraps>
...
80106050:	6a 3f                	push   $0x3f
  jmp alltraps
80106052:	e9 e0 f8 ff ff       	jmp    80105937 <alltraps>
...
80106059:	6a 40                	push   $0x40
  jmp alltraps
8010605b:	e9 d7 f8 ff ff       	jmp    80105937 <alltraps>
...
80106062:	6a 41                	push   $0x41
  jmp alltraps
80106064:	e9 ce f8 ff ff       	jmp    80105937 <alltraps>
...
8010606b:	6a 42                	push   $0x42
  jmp alltraps
8010606d:	e9 c5 f8 ff ff       	jmp    80105937 <alltraps>
...
80106074:	6a 43                	push   $0x43
  jmp alltraps
80106076:	e9 bc f8 ff ff       	jmp    80105937 <alltraps>
...
8010607d:	6a 44                	push   $0x44
  jmp alltraps
8010607f:	e9 b3 f8 ff ff       	jmp    80105937 <alltraps>
...
80106086:	6a 45                	push   $0x45
  jmp alltraps
80106088:	e9 aa f8 ff ff       	jmp    80105937 <alltraps>
...
8010608f:	6a 46                	push   $0x46
  jmp alltraps
80106091:	e9 a1 f8 ff ff       	jmp    80105937 <alltraps>
...
80106098:	6a 47                	push   $0x47
  jmp alltraps
8010609a:	e9 98 f8 ff ff       	jmp    80105937 <alltraps>
...
801060a1:	6a 48                	push   $0x48
  jmp alltraps
801060a3:	e9 8f f8 ff ff       	jmp    80105937 <alltraps>
...
801060aa:	6a 49                	push   $0x49
  jmp alltraps
801060ac:	e9 86 f8 ff ff       	jmp    80105937 <alltraps>
...
801060b3:	6a 4a                	push   $0x4a
  jmp alltraps
801060b5:	e9 7d f8 ff ff       	jmp    80105937 <alltraps>
...
801060bc:	6a 4b                	push   $0x4b
  jmp alltraps
801060be:	e9 74 f8 ff ff       	jmp    80105937 <alltraps>
...
801060c5:	6a 4c                	push   $0x4c
  jmp alltraps
801060c7:	e9 6b f8 ff ff       	jmp    80105937 <alltraps>
...
801060ce:	6a 4d                	push   $0x4d
  jmp alltraps
801060d0:	e9 62 f8 ff ff       	jmp    80105937 <alltraps>
...
801060d7:	6a 4e                	push   $0x4e
  jmp alltraps
801060d9:	e9 59 f8 ff ff       	jmp    80105937 <alltraps>
...
801060e0:	6a 4f                	push   $0x4f
  jmp alltraps
801060e2:	e9 50 f8 ff ff       	jmp    80105937 <alltraps>
...
801060e9:	6a 50                	push   $0x50
  jmp alltraps
801060eb:	e9 47 f8 ff ff       	jmp    80105937 <alltraps>
...
801060f2:	6a 51                	push   $0x51
  jmp alltraps
801060f4:	e9 3e f8 ff ff       	jmp    80105937 <alltraps>
...
801060fb:	6a 52                	push   $0x52
  jmp alltraps
801060fd:	e9 35 f8 ff ff       	jmp    80105937 <alltraps>
...
80106104:	6a 53                	push   $0x53
  jmp alltraps
80106106:	e9 2c f8 ff ff       	jmp    80105937 <alltraps>
...
8010610d:	6a 54                	push   $0x54
  jmp alltraps
8010610f:	e9 23 f8 ff ff       	jmp    80105937 <alltraps>
...
80106116:	6a 55                	push   $0x55
  jmp alltraps
80106118:	e9 1a f8 ff ff       	jmp    80105937 <alltraps>
...
8010611f:	6a 56                	push   $0x56
  jmp alltraps
80106121:	e9 11 f8 ff ff       	jmp    80105937 <alltraps>
...
80106128:	6a 57                	push   $0x57
  jmp alltraps
8010612a:	e9 08 f8 ff ff       	jmp    80105937 <alltraps>
...
80106131:	6a 58                	push   $0x58
  jmp alltraps
80106133:	e9 ff f7 ff ff       	jmp    80105937 <alltraps>
...
8010613a:	6a 59                	push   $0x59
  jmp alltraps
8010613c:	e9 f6 f7 ff ff       	jmp    80105937 <alltraps>
...
80106143:	6a 5a                	push   $0x5a
  jmp alltraps
80106145:	e9 ed f7 ff ff       	jmp    80105937 <alltraps>
...
8010614c:	6a 5b                	push   $0x5b
  jmp alltraps
8010614e:	e9 e4 f7 ff ff       	jmp    80105937 <alltraps>
...
80106155:	6a 5c                	push   $0x5c
  jmp alltraps
80106157:	e9 db f7 ff ff       	jmp    80105937 <alltraps>
...
8010615e:	6a 5d                	push   $0x5d
  jmp alltraps
80106160:	e9 d2 f7 ff ff       	jmp    80105937 <alltraps>
...
80106167:	6a 5e                	push   $0x5e
  jmp alltraps
80106169:	e9 c9 f7 ff ff       	jmp    80105937 <alltraps>
...
80106170:	6a 5f                	push   $0x5f
  jmp alltraps
80106172:	e9 c0 f7 ff ff       	jmp    80105937 <alltraps>
...
80106179:	6a 60                	push   $0x60
  jmp alltraps
8010617b:	e9 b7 f7 ff ff       	jmp    80105937 <alltraps>
...
80106182:	6a 61                	push   $0x61
  jmp alltraps
80106184:	e9 ae f7 ff ff       	jmp    80105937 <alltraps>
...
8010618b:	6a 62                	push   $0x62
  jmp alltraps
8010618d:	e9 a5 f7 ff ff       	jmp    80105937 <alltraps>
...
80106194:	6a 63                	push   $0x63
  jmp alltraps
80106196:	e9 9c f7 ff ff       	jmp    80105937 <alltraps>
...
8010619d:	6a 64                	push   $0x64
  jmp alltraps
8010619f:	e9 93 f7 ff ff       	jmp    80105937 <alltraps>
...
801061a6:	6a 65                	push   $0x65
  jmp alltraps
801061a8:	e9 8a f7 ff ff       	jmp    80105937 <alltraps>
...
801061af:	6a 66                	push   $0x66
  jmp alltraps
801061b1:	e9 81 f7 ff ff       	jmp    80105937 <alltraps>
...
801061b8:	6a 67                	push   $0x67
  jmp alltraps
801061ba:	e9 78 f7 ff ff       	jmp    80105937 <alltraps>
...
801061c1:	6a 68                	push   $0x68
  jmp alltraps
801061c3:	e9 6f f7 ff ff       	jmp    80105937 <alltraps>
...
801061ca:	6a 69                	push   $0x69
  jmp alltraps
801061cc:	e9 66 f7 ff ff       	jmp    80105937 <alltraps>
...
801061d3:	6a 6a                	push   $0x6a
  jmp alltraps
801061d5:	e9 5d f7 ff ff       	jmp    80105937 <alltraps>
...
801061dc:	6a 6b                	push   $0x6b
  jmp alltraps
801061de:	e9 54 f7 ff ff       	jmp    80105937 <alltraps>
...
801061e5:	6a 6c                	push   $0x6c
  jmp alltraps
801061e7:	e9 4b f7 ff ff       	jmp    80105937 <alltraps>
...
801061ee:	6a 6d                	push   $0x6d
  jmp alltraps
801061f0:	e9 42 f7 ff ff       	jmp    80105937 <alltraps>
...
801061f7:	6a 6e                	push   $0x6e
  jmp alltraps
801061f9:	e9 39 f7 ff ff       	jmp    80105937 <alltraps>
...
80106200:	6a 6f                	push   $0x6f
  jmp alltraps
80106202:	e9 30 f7 ff ff       	jmp    80105937 <alltraps>
...
80106209:	6a 70                	push   $0x70
  jmp alltraps
8010620b:	e9 27 f7 ff ff       	jmp    80105937 <alltraps>
...
80106212:	6a 71                	push   $0x71
  jmp alltraps
80106214:	e9 1e f7 ff ff       	jmp    80105937 <alltraps>
...
8010621b:	6a 72                	push   $0x72
  jmp alltraps
8010621d:	e9 15 f7 ff ff       	jmp    80105937 <alltraps>
...
80106224:	6a 73                	push   $0x73
  jmp alltraps
80106226:	e9 0c f7 ff ff       	jmp    80105937 <alltraps>
...
8010622d:	6a 74                	push   $0x74
  jmp alltraps
8010622f:	e9 03 f7 ff ff       	jmp    80105937 <alltraps>
...
80106236:	6a 75                	push   $0x75
  jmp alltraps
80106238:	e9 fa f6 ff ff       	jmp    80105937 <alltraps>
...
8010623f:	6a 76                	push   $0x76
  jmp alltraps
80106241:	e9 f1 f6 ff ff       	jmp    80105937 <alltraps>
...
80106251:	6a 78                	push   $0x78
  jmp alltraps
80106253:	e9 df f6 ff ff       	jmp    80105937 <alltraps>
...
8010625a:	6a 79                	push   $0x79
  jmp alltraps
8010625c:	e9 d6 f6 ff ff       	jmp    80105937 <alltraps>
...
80106263:	6a 7a                	push   $0x7a
  jmp alltraps
80106265:	e9 cd f6 ff ff       	jmp    80105937 <alltraps>
...
80106275:	6a 7c                	push   $0x7c
  jmp alltraps
80106277:	e9 bb f6 ff ff       	jmp    80105937 <alltraps>
...
8010627e:	6a 7d                	push   $0x7d
  jmp alltraps
80106280:	e9 b2 f6 ff ff       	jmp    80105937 <alltraps>
...
80106287:	6a 7e                	push   $0x7e
  jmp alltraps
80106289:	e9 a9 f6 ff ff       	jmp    80105937 <alltraps>
...
80106839:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
8010683e:	e9 f4 f0 ff ff       	jmp    80105937 <alltraps>
...
80106845:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010684a:	e9 e8 f0 ff ff       	jmp    80105937 <alltraps>
...
80106851:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106856:	e9 dc f0 ff ff       	jmp    80105937 <alltraps>
...
8010685d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106862:	e9 d0 f0 ff ff       	jmp    80105937 <alltraps>
...
80106869:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010686e:	e9 c4 f0 ff ff       	jmp    80105937 <alltraps>
...
80106875:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010687a:	e9 b8 f0 ff ff       	jmp    80105937 <alltraps>
...
80106881:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106886:	e9 ac f0 ff ff       	jmp    80105937 <alltraps>
...
8010688d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106892:	e9 a0 f0 ff ff       	jmp    80105937 <alltraps>
...
801069e5:	e8 76 dc ff ff       	call   80104660 <memset>
...
80106a2d:	68 50 7b 10 80       	push   $0x80107b50
...
80106a43:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106a46:	e8 05 cf ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
80106ad0:	a1 c4 44 11 80       	mov    0x801144c4,%eax
...
80106b04:	0f 84 c2 00 00 00    	je     80106bcc <switchuvm+0xec>
  pushcli();
80106b0a:	e8 41 d9 ff ff       	call   80104450 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106b0f:	e8 dc cd ff ff       	call   801038f0 <mycpu>
80106b14:	89 c3                	mov    %eax,%ebx
80106b16:	e8 d5 cd ff ff       	call   801038f0 <mycpu>
...
80106b28:	e8 c3 cd ff ff       	call   801038f0 <mycpu>
...
80106b76:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
80106b7d:	e8 6e cd ff ff       	call   801038f0 <mycpu>
...
80106b94:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106b97:	e8 54 cd ff ff       	call   801038f0 <mycpu>
...
80106c52:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c53:	e9 a8 da ff ff       	jmp    80104700 <memmove>
    panic("inituvm: more than a page");
80106c58:	83 ec 0c             	sub    $0xc,%esp
80106c5b:	68 95 7b 10 80       	push   $0x80107b95
...
80106cc0:	68 af 7b 10 80       	push   $0x80107baf
...
80106d48:	68 50 7c 10 80       	push   $0x80107c50
...
80106dab:	e8 b0 d8 ff ff       	call   80104660 <memset>
...
80106de9:	68 cd 7b 10 80       	push   $0x80107bcd
...
80106e4b:	68 e5 7b 10 80       	push   $0x80107be5
...
80106f2c:	68 01 7c 10 80       	push   $0x80107c01
...
80106f60:	e8 fb d6 ff ff       	call   80104660 <memset>
...
80106ffc:	68 12 7c 10 80       	push   $0x80107c12
...
80107072:	68 1c 7c 10 80       	push   $0x80107c1c
...
801070d0:	e8 2b d6 ff ff       	call   80104700 <memmove>
...
80107147:	68 36 7c 10 80       	push   $0x80107c36
...
80107200:	e8 fb d4 ff ff       	call   80104700 <memmove>
    len -= n;
    buf += n;
