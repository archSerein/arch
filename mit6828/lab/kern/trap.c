...
trap_init(void)
{
  ...
  SETGATE(idt[IRQ_SPURIOUS + IRQ_OFFSET], 0, GD_KT, irq_suprious_handler, 0);
  SETGATE(idt[IRQ_IDE + IRQ_OFFSET], 0, GD_KT, irq_ide_handler, 0);
  SETGATE(idt[IRQ_ERROR + IRQ_OFFSET], 0, GD_KT, irq_error_handler, 0);
