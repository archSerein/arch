...
class BankAccount:
    ...
    def changes(self, amount):
        ...
        self.transactions.append(Transaction(self.transactions_count, before, after))
...
def make_change(amount, coins):
    ...
    for coin in sorted_coins:
        if coin <= amount and coins[coin] > 0:
            remainder = amount - coin
            result = make_change(remainder, remove_one(coins, coin))
